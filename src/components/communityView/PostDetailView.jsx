      ...
      onSubmit: async (newText) => {
        try {
          ...
          const updated = payload.data
            ? mapComment(payload.data)
            : { ...comment, text: newText };
          setComments((list) =>
            list.map((c) => (c.id === commentId ? { ...c, ...updated } : c)),
          );
      ...
      onConfirm: () => {
        (async () => {
          try {
            ...
            const updated = {
              ...postState,
              comments: (postState?.comments || 1) - 1,
            };
      ...
      <div className="post-detail-board">
        <div className="pd-header">
          <div className="pd-header-top">
            ...
            <button className="close-detail-text-btn" onClick={onClose}>
              ×
            </button>
          </div>
          ...
          <div className="pd-meta-row">
            <div
              ...
              onClick={(e) =>
                onOpenUserProfile &&
                onOpenUserProfile(postState?.userId, postState?.author, e)
              }
              onKeyDown={(e) => {
            ...
            >
              ...
              <div className="pd-user-text">
                <span className="pd-username">
                  {postState?.author || "작성자"}
                </span>
                ...
                <div className="comment-content-wrapper">
                  <div className="comment-top-row">
                    <div
                      ...
                      onClick={(e) =>
                        onOpenUserProfile &&
                        onOpenUserProfile(c.userId, c.author, e)
                      }
                      onKeyDown={(e) => {
                        if (e.key === "Enter" && onOpenUserProfile)
                          onOpenUserProfile(c.userId, c.author, e);
                      ...
                      <div className="comment-menu-container">
                        <button
                          ...
                          onClick={(e) => {
                            e.stopPropagation();
                            setShowCommentMenu(
                              showCommentMenu === c.id ? null : c.id,
                            );
                          }}
                        >
                          ⋮
