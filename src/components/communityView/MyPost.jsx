                            ...
                            <div key={p.id} className="feed-card" onClick={() => onOpenPost && onOpenPost(p)} style={{ cursor: 'pointer', marginBottom: '15px' }}>
                                <div className="feed-header">
                                    ...
                                    <div className="feed-meta">
                                        ...
                                        >
                                            <svg width="16" height="16" viewBox="0 0 24 24" fill={p.liked ? '#e31c1c' : 'none'} stroke={p.liked ? '#e31c1c' : 'currentColor'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                                            {p.likes}
                                        </span>
                                        <span className="comment-count">💬 {p.comments}</span>
                                    </div>
