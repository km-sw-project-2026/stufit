...
// ──────────────────────────────────────────────────────
const BG = {
  background: "linear-gradient(160deg, #7ec8a0 0%, #a6d8b8 60%, #c2e8cf 100%)",
};
...
export default function WordChainGame() {
    ...
    return (
      ...
      >
        <div style={cardStyle}>
          ...
          />
          <p style={{ color: "#1d6b4f", fontWeight: 700, fontSize: "1.05rem" }}>
            로딩 중...
          </p>
          <div
            style={{
      ...
      >
        <div style={{ ...cardStyle, textAlign: "left" }}>
          <div style={{ textAlign: "center", marginBottom: "12px" }}>
            ...
            <p
              style={{ margin: "6px 0 0", fontSize: "0.88rem", color: "#555" }}
            >
          ...
          >
            <p style={{ margin: "0 0 4px", fontWeight: 700, color: "#7a6b00" }}>
              📋 게임 규칙
            </p>
            <ul style={{ margin: 0, paddingLeft: "18px" }}>
              ...
              <li>
                제한 시간:{" "}
                <strong>
                  {START_TURN_SECONDS}초 → 최소 {MIN_TURN_SECONDS}초
                </strong>{" "}
                (턴마다 점점 감소) — 초과 시 자동 패배
              </li>
              <li>
                <strong>한국어 위키백과 표제어</strong>가 아닌 단어 / 이미
                사용한 단어는 인정되지 않습니다.
              </li>
              <li>
                AI가 응답하지 못하면 <strong>한방단어</strong> — 즉시 승리!
              </li>
            </ul>
          </div>
          ...
          >
            <p style={{ margin: "0 0 6px", fontWeight: 700, color: "#1d6b4f" }}>
              🏅 채점 기준
            </p>
            <div
              style={{
            ...
            >
              <span>단어 1개 제출</span>
              <span style={{ fontWeight: 600, color: "#1d8c66" }}>+10점</span>
              <span>5초 이내 입력</span>
              <span style={{ fontWeight: 600, color: "#1d8c66" }}>+7점</span>
              <span>10초 이내 입력</span>
              <span style={{ fontWeight: 600, color: "#1d8c66" }}>+3점</span>
              <span>4글자 이상 단어</span>
              <span style={{ fontWeight: 600, color: "#1d8c66" }}>
                +(글자수-3)×3점
              </span>
              <span>AI 한방단어 (승리)</span>
              <span style={{ fontWeight: 600, color: "#1d8c66" }}>+50점</span>
            </div>
            <p
              style={{ margin: "8px 0 0", color: "#888", fontSize: "0.78rem" }}
            >
              * 시간이 초과되면 현재 점수로 마감됩니다. 점수가 높을수록 최종
              순위가 높아집니다.
            </p>
          </div>
  ...
  if (phase === "playing") {
    ...
    const timerColor =
      timeLeft <= 5 ? "#e74c3c" : timeLeft <= 10 ? "#e67e22" : "#1d8c66";
        ...
        <div style={{ ...cardStyle, maxWidth: "560px" }}>
          ...
          >
            ...
            >
              <span>
                점수:{" "}
                <span style={{ color: "#1d8c66", fontSize: "1rem" }}>
                  {score}
                </span>
              </span>
              <span>
          ...
          <div style={{ marginBottom: "12px" }}>
            ...
            <p
              style={{
                ...
                fontSize: "0.8rem",
                color: timerColor,
                fontWeight: timerPct <= 33 ? 700 : 400,
                textAlign: "right",
              }}
            >
            ...
            {lastWord ? (
              <>
                ...
                >
                  {lastWord.slice(0, -1)}
                  <span
                    style={{ color: "#1d8c66", textDecoration: "underline" }}
                  >
                    {lastWord[lastWord.length - 1]}
                  </span>
                </span>
                <span
                  style={{ fontSize: "0.82rem", color: "#777", flexShrink: 0 }}
                >
                  ↳{" "}
                  <strong style={{ color: "#1d8c66" }}>'{requiredChar}'</strong>
                  (으)로 시작
                </span>
              </>
            ) : (
          ...
          {aiThinking ? (
            ...
            >
              ...
              <button
                type="submit"
                style={{ ...tealBtn, opacity: submitting ? 0.6 : 1 }}
                disabled={submitting}
              >
                {submitting ? "..." : "제출"}
              </button>
      ...
      <div style={{ ...cardStyle, textAlign: "left" }}>
        ...
        >
          <div style={{ textAlign: "center" }}>
            <p
              style={{ margin: "0 0 4px", fontSize: "0.78rem", color: "#888" }}
            >
              최종 점수
            </p>
            <p
              ...
              {history.map((h, i) => (
                ...
                >
                  <span
                    style={{
                      background:
                        h.speaker === "player" ? "#1d8c66" : "#e8f5ef",
                      color: h.speaker === "player" ? "#fff" : "#1d6b4f",
                      borderRadius: "12px",
                      padding: "2px 10px",
                      fontSize: "0.75rem",
                    ...
                    >
                      ...
                      <td
                        style={{
                          padding: "8px 12px",
                          fontWeight:
                            r.player_username === username ? 700 : 400,
                        }}
                      >
                        {r.player_username}
                        {r.player_username === username ? " (나)" : ""}
                      </td>
                      <td
                        style={{
                          padding: "8px 12px",
