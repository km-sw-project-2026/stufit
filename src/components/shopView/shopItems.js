...
export const shopItems = [
    { id: 1, category: '프로필 테두리', name: '너는 못 사는 VIP 테두리', price: '3,000 P', color: '#fff', type: 'frame', image: frameVip },
    ...
    { id: 4, category: '프로필 테두리', name: '맥도날드 모자 테두리', price: '3,000 P', color: '#fff', type: 'frame', image: frameMcHat },
    ...
    { id: 7, category: '프로필 테두리', name: '슈퍼스타 테두리', price: '3,000 P', color: '#fff', type: 'frame', image: frameSuperstar },
    { id: 8, category: '프로필 테두리', name: '아보카도 테두리', price: '3,000 P', color: '#fff', type: 'frame', image: frameAvocado },
    { id: 9, category: '프로필 테두리', name: '치킨 오돌뼈로 태어난 테두리', price: '3,000 P', color: '#fff', type: 'frame', image: frameChicken },
    ...
    { id: 17, category: '프로필 배경', name: '왕좌 배경', price: '3,000 P', color: '#fff', type: 'bg', image: bgThrone },
    { id: 18, category: '프로필 배경', name: '이빨 배경', price: '3,000 P', color: '#fff', type: 'bg', image: bgTeeth },
    ...
    { id: 22, category: '프로필 이미지', name: '갈매기', price: '4,500 P', color: '#ff6347', type: 'image', image: seagullImg },
    { id: 23, category: '프로필 이미지', name: '앵무새', price: '5,500 P', color: '#4169e1', type: 'image', image: parrotImg },
    { id: 24, category: '프로필 이미지', name: '오리', price: '5,000 P', color: '#9370db', type: 'image', image: duckImg },
    { id: 25, category: '프로필 이미지', name: '우산 슬라임', price: '4,800 P', color: '#8b4513', type: 'image', image: slimeUmbrellaImg },
    { id: 26, category: '프로필 이미지', name: '해파리', price: '6,000 P', color: '#fff0f5', type: 'image', image: jellyfishImg },
    { id: 27, category: '프로필 이미지', name: '펌킨', price: '5,200 P', color: '#8b0000', type: 'image', image: pumpkinImg },
    { id: 28, category: '프로필 이미지', name: '유령', price: '3,800 P', color: '#f2f2f2', type: 'image', image: ghostImg },
    { id: 29, category: '프로필 이미지', name: '유독성 슬러지', price: '4,100 P', color: '#a7d46f', type: 'image', image: toxicSludgeImg },
    { id: 30, category: '프로필 이미지', name: '아귀', price: '4,100 P', color: '#a7d46f', type: 'image', image: anglerfishImg },
];
