      ...
      <div className="ranking-header-section">
        ...
        <div className="rank-card rank-2">
          ...
          <div
            ...
            onClick={(e) => openUserProfile(top2, e)}
          >
            {top2?.username || "데이터 없음"}
          </div>
          <div className="rank-user-label">점수</div>
          <div className="rank-user-score">
            {top2?.score.toLocaleString() || 0}
          </div>
        </div>
        ...
        <div className="rank-card rank-1">
          ...
          <div
            className="rank-user-name"
            style={{ cursor: "pointer" }}
            onClick={(e) => openUserProfile(top1, e)}
          >
            {top1?.username || "데이터 없음"}
          </div>
          <div className="rank-user-label">점수</div>
          <div className="rank-user-score">
            {top1?.score.toLocaleString() || 0}
          </div>
        </div>
        ...
        <div className="rank-card rank-3">
          ...
          <div
            className="rank-user-name"
            style={{ cursor: "pointer" }}
            onClick={(e) => openUserProfile(top3, e)}
          >
            {top3?.username || "데이터 없음"}
          </div>
          <div className="rank-user-label">점수</div>
          <div className="rank-user-score">
            {top3?.score.toLocaleString() || 0}
          </div>
        </div>
      </div>
        ...
        <div className="ranking-grid-list">
          ...
          {searchResult ? (
            <div
              ...
              style={{ border: "2px solid #005a44" }}
            >
              <div className="r-left">
                <span className="r-rank">
                  {rankings.indexOf(searchResult) + 1}
                </span>
                <span
                  className="r-name"
                  style={{ cursor: "pointer" }}
                  onClick={(e) => openUserProfile(searchResult, e)}
                >
